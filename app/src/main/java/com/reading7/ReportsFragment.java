...
public class ReportsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.reports_fragment, null);
    }
    ...
    private void createNotifications(final RecyclerView notificationsRV) {
        ...
        final CollectionReference requestCollectionRef = db.collection("Reports");
        ...
        requestQuery.get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    final NotificationListAdapter adapter = new NotificationListAdapter(getActivity(), notifications,getActivity(),ReportsFragment.this);

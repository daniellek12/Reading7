...
public CustomShelfAdapter(ArrayList<String> bookNames, Context context){
    ...
    @NonNull
    @Override
    public CustomShelfAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        LayoutInflater mInflater = LayoutInflater.from(mContext);
        View view = mInflater.inflate(R.layout.playlist_item, viewGroup,false);
        return new CustomShelfAdapter.ViewHolder(view);
    }


    @Override
    public void onBindViewHolder(@NonNull final CustomShelfAdapter.ViewHolder viewHolder, final int i) {
...
//    public void deleteBook(String bookName) {
    // TODO write this function correctly (is it needed?)
